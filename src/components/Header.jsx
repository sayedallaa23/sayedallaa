...
export function SpotlightPreview() {
  ...
  return (
    (<div
      className="h-[25rem] md:h-[40rem] w-full flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden stars">
