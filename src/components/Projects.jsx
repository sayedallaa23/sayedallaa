    ...
    <div>
        ...
        <div className='relative h-[115vh] md:h-[90vh] lg:h-[160vh] mt-[4rem]'>
            ...
            <div className='absolute bottom-0 left-0 w-[100%] h-[105vh] md:h-auto'>
                ...
                <ThreeDCardDemo websiteName="PopcornTv" websiteDis="PopcornTV is a movie and TV platform , offering a wide database of films and series with synopses, ratings, and personalised recommendations." websiteImg="/popcorn3.jpg" websiteLink="https://popcorn-tv-seven.vercel.app/"/>
