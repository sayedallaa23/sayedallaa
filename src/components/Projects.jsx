    ...
    <div>
        ...
        <div className='relative h-[115vh] md:h-[90vh] lg:h-[160vh] mt-[4rem]'>
            ...
            <div className='absolute bottom-0 left-0 w-[100%] h-[105vh] md:h-auto'>
                ...
                <ThreeDCardDemo websiteName="PlushPalace" websiteDis="PlushPalace is a 3D furniture agency landing page showcases innovative designs with interactive displays and a seamless user experience." websiteImg="/plushpalace2.jpg" websiteLink="www.google.com"/>
