    ...
    <div>
        ...
        <div className='relative h-[160vh]'>
            ...
            <div className='absolute bottom-0 left-[3rem]'>
                ...
                <ThreeDCardDemo websiteName="Kicks" websiteDis="Kicks is an e-commerce site for shoes, featuring a variety of styles, easy navigation, and customer reviews." websiteImg="/kicks.png" websiteLink="https://kicks-kappa.vercel.app/"/>
                </div>
