...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        "relative flex h-[50vh] lg:min-h-screen flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#4d4d4d] via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-[#4d4d4d] text-white [--conic-position:from_290deg_at_center_top]">
          <div
        ...
        <div
          className="absolute w-full h-48 scale-x-150 translate-y-12 bg-black top-1/2 blur-2xl"></div>
        <div
          className="absolute z-50 w-full h-48 bg-transparent top-1/2 opacity-10 backdrop-blur-md"></div>
        <div
          className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#000000] opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-[#595757] blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-[#e5e5e5] "></motion.div>
